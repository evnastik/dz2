...
$arAllOptions = [
    'main' => [
        ...
        ["checkbox", 'checkbox', '', ['checkbox', '', 'onclick=""']],
        ["selectbox", 'selectbox', '', ['selectbox', ["val1"  =>  Loc::getMessage("YLAB.IMPORT.VAL1"),  "val2"  =>  Loc::getMessage("YLAB.IMPORT.VAL2"),  "val3"  =>  Loc::getMessage("YLAB.IMPORT.VAL3")]]],
